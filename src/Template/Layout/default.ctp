...
<head>
    ...
    <?= $this->Html->css('/template/assets/css/pages/helpdesk.css') ?>
    ...
    <?= $this->Html->script('/template/plugins/scrollbar/jquery.mCustomScrollbar.concat.min.js') ?>
    <?= $this->Html->script('/template/assets/js/app.js') ?>
    ...
    <ul class="navbar-nav flex-row ml-lg-auto w-100">
        <li class="nav-item dropdown user-profile-dropdown w-100 text-center">
            <div class="nav-toggle d-inline-block float-left mt-2">
                ...
                <a href="index.html" class="ml-3"><?= $this->Html->image('/template/assets/img/ARME.png',['class'=>'theme-logo','alt'=>'logo','style'=>'width:70px;']) ?>
                </a>
            </div>
            ...
            <div class="dropdown-menu p-0 mt-5" aria-labelledby="dropdownMenuButton">
                ...
                <?php  echo $this->Html->link('<i class="mr-2 flaticon-power-off"></i> <span class="align-self-center">Logout</span>',['controller'=>'users','action'=>'logout'],array('escape' => false)); ?>
...
<header class="desktop-nav header navbar fixed-top">
    <div class="nav-logo mr-5 ml-4 d-lg-inline-block d-none">
        <a href="index.html" class="">             <?= $this->Html->image('/template/assets/img/ARME.png',['class'=>'theme-logo','alt'=>'logo','style'=>'width:70px;']) ?>
        </a>
    </div>
        ...
        <!--<li class="nav-item dropdown language-dropdown mr-5  d-lg-inline-block d-none">
            ...
            <div class="dropdown-menu position-absolute" aria-labelledby="language-dropdown">
                <a class="dropdown-item d-flex" href="javascript:void(0);"><img src="assets/img/de.png"
                                                                                class="flag-width mr-3" alt=""> <span
                ...
                <div class="notification-scroll">
                    <div class="dropdown-item">
                        <div class="">
                            ...
                            <p class="notification-text"><span class="meta-usrname">Kara Young</span>, <span
                                class="meta-usrname">Xavier</span>, <span class="meta-usrname">Lila Perry</span> and
                                <span class="meta-usrname">3 others</span> send a friend request.</p>
                    ...
                    <div class="dropdown-item">
                        <div class="">
                            ...
                            <p class="notification-text"><span class="meta-usrname">Shaun</span>, <span
                                class="meta-usrname">Amy Diaz</span> and <span class="meta-usrname">3 others</span> send
                                a friend request.</p>
                    ...
                    <div class="dropdown-item">
                        <div class="">
                            ...
                            <p class="notification-text"><span class="meta-usrname">Marry McDonald</span>, <span
                                class="meta-usrname">Shaun Park</span>, <span class="meta-usrname">Kara</span> and <span
                                class="meta-usrname">3 others</span> send a friend request.</p>
            ...
            <ul class="nav nav-tabs nav-justified mx-2">
                <li class="nav-item">
                    <a data-toggle="tab" href="#task-tab"
                       class="nav-link rounded-circle  justify-content-center d-flex active show">
                        <p class="mb-0">Task</p>
                        <i class="align-self-center flaticon-notes"></i>
                    </a>
                </li>
                <li class="nav-item">
                    <a data-toggle="tab" href="#friends-tab"
                       class="nav-link rounded-circle  justify-content-center d-flex">
                        <p class="mb-0">Friends</p>
                        <i class="align-self-center flaticon-user-8"></i>
                    </a>
                </li>
                <li class="nav-item">
                    <a data-toggle="tab" href="#settings-tab"
                       class="nav-link rounded-circle  justify-content-center d-flex">
                    ...
                    <div class="admin-setting">
                        ...
                        <div class="mb-3 mt-5">
                            <div class="d-flex justify-content-between">
                                ...
                                <label
                                    class="custom-control material-switch mb-4 mt-1 material-s-rounded material-primary">
                    ...
                    <div class="general-setting mt-5">
                        ...
                        <div class="chk-settings mt-5">
                            ...
                            <div class="media mb-4 ">
                                <div class="media-body">
                                    <h6 class="media-heading mt-0 mb-3"><span
                                        class="media-title">Report panel usage</span>
                                    </h6>
                                    <p class="media-text">
                            ...
                            <div class="media mb-4 ">
                                <div class="media-body">
                                    <h6 class="media-heading mt-0 mb-3"><span
                                        class="media-title">Allow mail redirect</span>
                                    </h6>
                                    <p class="media-text">
                            ...
                            <div class="media mb-4 ">
                                <div class="media-body">
                                    <h6 class="media-heading mt-0 mb-3"><span
                                        class="media-title"> Show me as Online </span>
                                    </h6>
                                </div>
                                <div class="n-chk">
                                    <label class="new-control new-checkbox checkbox-secondary mr-1">
                        ...
                        <div class="mt-5 delete-chat">
                            ...
                            <div class="media mb-4">
                                <div class="media-body">
                                    <h6 class="media-heading mt-0 mb-3"><span
                                        class="media-title"> Delete chat history</span>
                                    </h6>
                                </div>
